...
class OverseeX {
    ...
    async execute() {
        ...
        const baseUrl = credentials.baseUrl || 'https://api.overseex.com';
            ...
            try {
                ...
                if (resource === 'trace') {
                    if (operation === 'create') {
                        ...
                        method = 'POST';
                        body = {
                            agent_id: this.getNodeParameter('traceAgentId', i),
                            input_data: JSON.parse(this.getNodeParameter('inputData', i)),
                            output_data: JSON.parse(this.getNodeParameter('outputData', i)),
                            status: this.getNodeParameter('status', i),
                            total_duration_ms: this.getNodeParameter('durationMs', i),
                            metadata: { source: 'n8n' },
                            tags: ['n8n'],
                        };
                    }
                        ...
                        const agentId = this.getNodeParameter('listAgentId', i);
                ...
                if (resource === 'coordination') {
                    if (operation === 'analyze') {
                        ...
                        method = 'POST';
                        const traceIdsStr = this.getNodeParameter('analyzeTraceIds', i);
                        body = {
